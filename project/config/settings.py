"""
Django settings for project HalalDamu.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-z%j8%$wkxait0i$5w22*2n6^00s(*s1e2ardqk+53r0r+)hsx@')
...
# See https://docs.djangoproject.com/en/3.2/ref/settings/#force-script-name
...
APP_VERSION = '1.0.0'
APP_NAME = 'HalalDamu'
APP_DESCRIPTION = 'A RESTfull API for project HalalDamu'
